...
namespace TerraLeague.Items.SummonerSpells
{
    public class IgniteRune : SummonerSpell
    {
        ...
        {
            return "TerraLeague/Items/SummonerSpells/Ignite";
        }
        ...
        public override void DoEffect(Player player, int spellSlot)
        {
            ...
            if (npc != -1)
            {
                Projectile.NewProjectile(player.GetProjectileSource_Item(Item), player.Center, Vector2.Zero, ProjectileType<Summoner_Ignite>(), 1, 0, player.whoAmI, npc);
