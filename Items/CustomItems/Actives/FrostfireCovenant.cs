...
namespace TerraLeague.Items.CustomItems.Actives
{
    public class FrostfireCovenant : Active
    {
        ...
        public void DoAction(int target, Player player, LeagueItem modItem)
        {
            ...
            Projectile.NewProjectileDirect(player.GetProjectileSource_Item(modItem.Item), player.Center, Vector2.Zero, ProjectileType<Item_FrostStorm>(), damage, 0, player.whoAmI, target).timeLeft = effectDuration * 60;
            SetCooldown(player);
        }
    }
}
