...
namespace TerraLeague.Items.CustomItems.Passives
{
    public class Executioner : Passive
    {
        ...
        {
            return TooltipName("REND") + LeagueTooltip.CreateColorString(PassiveSecondaryColor, "Melee and ranged attacks apply 'Greivous Wounds' for " + debuffDuration + " seconds");
        }
