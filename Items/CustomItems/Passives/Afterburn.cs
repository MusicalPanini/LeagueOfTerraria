...
namespace TerraLeague.Items.CustomItems.Passives
{
    public class Afterburn : Passive
    {
        ...
        public override string Tooltip(Player player, ModItem modItem)
        {
            ...
            return TooltipName("Afterburn") + LeagueTooltip.CreateColorString(PassiveSecondaryColor, "Melee and ranged damage deal ") +
                LeagueTooltip.TooltipValue(0, false, "", 
                new System.Tuple<int, ScaleType>(meleeScaling, ScaleType.Melee),
                new System.Tuple<int, ScaleType>(rangedScaling, ScaleType.Ranged),
                new System.Tuple<int, ScaleType>(magicScaling, ScaleType.Magic),
                new System.Tuple<int, ScaleType>(minionScaling, ScaleType.Summon))
                + LeagueTooltip.CreateColorString(PassiveSecondaryColor, " On Hit damage");
        }
