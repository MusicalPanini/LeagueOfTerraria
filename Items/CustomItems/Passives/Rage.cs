...
namespace TerraLeague.Items.CustomItems.Passives
{
    public class Rage : Passive
    {
        ...
        public Rage(int SecondsDuration, LeagueItem legItem) : base(legItem)
        {
        ...
        {
            return TooltipName("RAGE") + LeagueTooltip.CreateColorString(PassiveSecondaryColor, "Melee attacks increased movement speed for " + duration + " seconds");
        }
