    ...
    abstract public class AbilityItem : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (tt != null)
            {
                ...
                {
                    text += "\n[c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityNameColor)).Hex3() + ":Ability " + LeagueTooltip.ConvertKeyString(TerraLeague.QAbility) + ":] [c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityButtonColor)).Hex3() + ":" + Abilities[(int)AbilityType.Q].GetAbilityName() + "]" +
                        "\n" + Abilities[(int)AbilityType.Q].GetTooltip();
                }
                if (GetIfAbilityExists(AbilityType.W))
                {
                    text += "\n[c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityNameColor)).Hex3() + ":Ability " + LeagueTooltip.ConvertKeyString(TerraLeague.WAbility) + ":] [c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityButtonColor)).Hex3() + ":" + Abilities[(int)AbilityType.W].GetAbilityName() + "]" +
                        "\n" + Abilities[(int)AbilityType.W].GetTooltip();
                }
                if (GetIfAbilityExists(AbilityType.E))
                {
                    text += "\n[c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityNameColor)).Hex3() + ":Ability " + LeagueTooltip.ConvertKeyString(TerraLeague.EAbility) + ":] [c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityButtonColor)).Hex3() + ":" + Abilities[(int)AbilityType.E].GetAbilityName() + "]" +
                        "\n" + Abilities[(int)AbilityType.E].GetTooltip();
                }
                if (GetIfAbilityExists(AbilityType.R))
                {
                    text += "\n[c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityNameColor)).Hex3() + ":Ability " + LeagueTooltip.ConvertKeyString(TerraLeague.RAbility) + ":] [c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(AbilityButtonColor)).Hex3() + ":" + Abilities[(int)AbilityType.R].GetAbilityName() + "]" +
                        "\n" + Abilities[(int)AbilityType.R].GetTooltip();
                }
                text += "\n[c/" + LeagueTooltip.PulseText(LeagueTooltip.ConvertHexToColor(QuoteColor)).Hex3() + ":'" + GetQuote() + "']";
