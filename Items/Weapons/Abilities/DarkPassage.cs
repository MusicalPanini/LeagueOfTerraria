...
namespace TerraLeague.Items.Weapons.Abilities
{
    public class DarkPassage : Ability
    {
        ...
        {
            return "TerraLeague/AbilityImages/DarkPassage";
        }
        ...
        {
            return LeagueTooltip.TooltipValue(GetAbilityBaseDamage(player), true, "", new Tuple<int, ScaleType>(GetAbilityScalingAmount(player, DamageType.MEL), ScaleType.Melee)) + " shielding";
        }
