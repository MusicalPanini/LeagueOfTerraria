...
namespace TerraLeague.Projectiles
{
    public class ChainedRocketHand_RobotFist : ModProjectile
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("TerraLeague/Projectiles/ChainedRocketHand_RobotChain").Value;
            ...
            Texture2D robotBase = ModContent.Request<Texture2D>("TerraLeague/Projectiles/ChainedRocketHand_RobotBase").Value;
