...
namespace TerraLeague.Projectiles
{
	public class Gravitum_Orb : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Dust dust = Dust.NewDustDirect(projectile.position + Vector2.One * 4, projectile.width - 8, projectile.height- 8, DustID.UndergroundHallowedEnemies, 0f, 0f, 100, default, 1.5f);
                dust.noGravity = true;
                dust.velocity *= 0.3f;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                dust = Dust.NewDustDirect(new Vector2(projectile.position.X + projectile.width / 4, projectile.position.Y + projectile.width / 4), projectile.width / 2, projectile.height / 2, DustID.UndergroundHallowedEnemies, 0f, 0f, 100, default, 2f);
                dust.noGravity = true;
                dust.velocity *= 3f;
                dust.velocity = (dust.position - projectile.Center) * 0.1f;
                dust.fadeIn = 2.5f;
