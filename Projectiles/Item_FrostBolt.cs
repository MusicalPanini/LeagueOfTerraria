...
namespace TerraLeague.Projectiles
{
    public class Item_FrostBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.IcyMerman, projectile.velocity.X, projectile.velocity.Y, 100, default, 1.5f);
            dust.noGravity = true;
            dust.noLight = true;
            dust.velocity *= 0.1f;
