    ...
    public class TerrorOfTheVoid_RuptureSpike : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.timeLeft > 90)
            {
                ...
                {
                    Dust dustIndex = Dust.NewDustDirect(new Vector2(projectile.position.X, projectile.position.Y + projectile.height), projectile.width, 32, DustID.Moss_Purple, 0f, 0f, 0, default, 1.5f);
                }
            }
            ...
            if (projectile.timeLeft == 84)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    Dust dustIndex = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.Moss_Purple, 0f, -4f, projectile.alpha, default, 2);
                }
