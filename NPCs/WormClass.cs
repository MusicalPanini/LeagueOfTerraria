    ...
    public override void AI()
    {
        ...
        if (!flag18)
        {
            for (int num184 = num180; num184 < num181; num184++)
            {
                ...
                {
                    if (Main.tile[num184, num185] != null && (Main.tile[num184, num185].IsActuated && (Main.tileSolid[(int)Main.tile[num184, num185].type] || Main.tileSolidTop[(int)Main.tile[num184, num185].type] && Main.tile[num184, num185].frameY == 0) || Main.tile[num184, num185].LiquidAmount > 64))
                    {
                        Vector2 vector17;
                        ...
                        {
                            flag18 = true;
                            if (Main.rand.NextBool(100) && NPC.behindTiles && Main.tile[num184, num185].IsActuated)
                            {
