...
{
    public class TaintedSkeleton : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tainted Skeleton");
            Main.npcFrameCount[NPC.type] = Main.npcFrameCount[NPCID.SporeSkeleton];
        ...
        {
            NPC.CloneDefaults(NPCID.SporeSkeleton);
            NPC.damage = 24;
            NPC.defense = 10;
            NPC.lifeMax = 40;
            NPC.value = 100f;
            AnimationType = NPCID.SporeSkeleton;
            //Banner = NPC.type;
        ...
        {
            target.GetModPlayer<PLAYERGLOBAL>().AddVoidInfluence(150, false);
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("The necromagic magic which allows skeletons to walk again seems mesh quite well with the reconstructed matter the void produces")
			});
		}
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            TerraLeague.GetTextureIfNull(ref texture, "TerraLeague/NPCs/VoidNPCs/TaintedSkeleton_Glow");
            ...
            (
                ...
                (
                    ...
                    NPC.position.Y - Main.screenPosition.Y + NPC.height * 0.5f - 12
                ),
